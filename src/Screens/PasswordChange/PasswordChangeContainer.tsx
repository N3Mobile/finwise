...
export const PasswordChangeContainer = () => {
  ...
  const [confirmNewPassword, setConfirmNewPassword] = useState<State>({
    value: "",
    error: "",
  });
    ...
    if (
      ...
      try {
        const response = await axios.patch(
          "https://be-mobile-n3.onrender.com/Users/password",
          {
            email: email.value,
  ...
  return (
    ...
    >
      <Appbar.Header>
        ...
        <Appbar.Content title={i18n.t(LocalizationKey.LOGIN_FORGOT_PASSWORD)} />
      </Appbar.Header>
      <ScrollView
        ...
        <TouchableWithoutFeedback onPress={handlePressOutside}>
          <View style={styles.container}>
            ...
            <TextInput
              ...
              style={[
                styles.input,
                currentPassword.error ? styles.inputError : null,
              ]}
              contentStyle={styles.content}
              activeUnderlineColor="gray"
            />
            ...
            <TextInput
              ...
              style={[
                styles.input,
                newPassword.error ? styles.inputError : null,
              ]}
              contentStyle={styles.content}
              activeUnderlineColor="gray"
            />
            ...
            <TextInput
              ...
              style={[
                styles.input,
                confirmNewPassword.error ? styles.inputError : null,
              ]}
              contentStyle={styles.content}
              activeUnderlineColor="gray"
            />
            {confirmNewPassword.error ? (
              <Text style={styles.errorText}>{confirmNewPassword.error}</Text>
            ) : null}
            ...
            <View style={styles.row}>
              ...
              <TouchableOpacity onPress={() => navigation.goBack()}>
                <Text style={styles.link}>
                  {i18n.t(LocalizationKey.GO_BACK)}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
