...
export const AddTransactionContainer = () => {
  ...
  const handleAmountChange = (value: string) => {
    ...
    if (numericValue === "0" || (numericValue.startsWith("0") && numericValue !== "0")) {
  ...
  const fetchWalletId = async () => {
    ...
    try {
      const url = `https://be-mobile-n3.onrender.com/wallets/byWalletsId?_id=${encodeURIComponent(walletId)}`;
        ...
        <View style={styles.container}>
          ...
          <List.Section>
            ...
            <List.Item
              ...
              right={() => (
                <View style={styles.transactionTypeContainer}>
                  ...
                  >
                    <View
                      style={[
                        ...
                        transactionType === "Thu" && styles.selectedIncomeType,
                      ]}
                    >
                  ...
                  <TouchableWithoutFeedback
                    onPress={() => setTransactionType("Chi")}
                  >
                    <View
                      style={[
                        styles.transactionTypeButton,
                        transactionType === "Chi" && styles.selectedOutcomeType,
                      ]}
                    >
                      <Text style={styles.transactionTypeButtonText}>
            ...
            <List.Item
              ...
              descriptionStyle={styles.description}
              description={
                selectedCategory || i18n.t(LocalizationKey.SELECT_CATEGORY)
              }
              left={() => (
                <List.Icon
                  color={
